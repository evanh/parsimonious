...
class TreeTests(TestCase):
    ...
    def test_simple_node(self):
        ...
        assert h.match('hello') == Node(h, 'hello', 0, 5)
    ...
    def test_sequence_nodes(self):
        ...
        text = 'heighho'
        assert s.match(text) == Node(s, text, 0, 7, children=
    ...
    def test_one_of(self):
        ...
        text = 'aa'
        assert o.match(text) == Node(o, text, 0, 1, children=[
    ...
    def test_optional(self):
        ...
        text = 'a'
        assert expr.match(text) == Node(expr, text, 0, 1, children=[
        ...
        text = ''
        assert expr.match(text) == Node(expr, text, 0, 0)
...
class ParseTests(TestCase):
    ...
    def test_parse_success(self):
        ...
        text = 'aa'
        assert expr.parse(text) == Node(expr, text, 0, 2, children=[
                                   Node(expr.members[0], text, 0, 1),
...
class ErrorReportingTests(TestCase):
    ...
    def test_inner_rule_succeeding(self):
        ...
        try:
            ...
            assert error.pos == 6
            assert error.expr == grammar['close_parens']
            assert error.text == text
            assert text_type(error) == "Rule 'close_parens' didn't match at '!!' (line 1, column 7)."
    ...
    def test_rewinding(self):
        ...
        try:
            ...
            assert error.pos == 8
            assert error.expr == grammar['bork']
            assert error.text == text
    ...
    def test_parse_with_leftovers(self):
        ...
        try:
            ...
            assert text_type(error), u"Rule 'sequence' matched in its entirety, but it didn't consume all the text. The non-matching portion of the text begins with 'bang' (line 1 == column 12)."
    ...
    def test_favoring_named_rules(self):
        ...
        try:
            ...
            assert text_type(error), u"Rule 'starts_with_a' didn't match at 'burp' (line 1 == column 1)."
    ...
    def test_line_and_column(self):
        ...
        try:
            ...
            assert text_type(error).endswith(r"""didn't match at 'GOO' (line 2, column 4).""")
...
class RepresentationTests(TestCase):
    ...
    def test_unicode_keep_parens(self):
        ...
        """
        # ZeroOrMore
        assert text_type(Grammar('foo = "bar" ("baz" "eggs")* "spam"')) == u'foo = "bar" ("baz" "eggs")* "spam"'
        ...
        # Multiple sequences
        assert text_type(Grammar('foo = ("bar" "baz") / ("baff" "bam")')) == u'foo = ("bar" "baz") / ("baff" "bam")'
    ...
    def test_unicode_surrounding_parens(self):
        ...
        """
        assert text_type(Grammar('foo = ("foo" ("bar" "baz"))')) == u'foo = "foo" ("bar" "baz")'
...
class SlotsTests(TestCase):
    ...
    def test_subclassing(self):
        ...
        smoo = Smoo()
        assert smoo.__dict__ == {}  # has a __dict__ but with no smoo in it
        assert smoo.smoo == 'smoo'  # The smoo attr ended up in a slot.
